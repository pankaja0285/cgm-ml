...
MODEL_CONFIG = dotdict(dict(
    ...
    EXPERIMENT_NAME='q3-depthmap-plaincnn-height-95k-ps',
    RUN_ID='q3-depthmap-plaincnn-height-95k-ps_1604844442_da24a8d9',  # Run 6
