...
neptune.init(
    ...
    project_qualified_name="cgm-ml/height" 
)
#add a detailed description of the experiment
description = "Training a Resnet for height prediction on RGBD dataset (500 qr codes) with dropout"
...
if(run.id.startswith("OfflineRun")):
    ...
    dataset_path="/mnt/preprocessed/rgbd56k/"
...
neptune.create_experiment(name="rgbd1",
                          params={**model_params, **training_params, **optim_params},
                          tags=['RGBD','500QR','2020Q4','US76'],
